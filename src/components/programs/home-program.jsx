        ...
        <div className="row justify-content-center">
          <div className="col-lg-8">
            ...
            >
              ...
              <p>
                In Montessori Schools, children are grouped according to
                developmental stages rather than being separated on the basis of
                age/grade. In this way, we create little communities of learners
                who
                <br /> help one another to learn and grow.
              </p>
            </div>
          </div>
        </div>
